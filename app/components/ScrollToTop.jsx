...
export const ScrollToTop = () => {
  ...
  useEffect(() => {
    let calcScrollValue = () => {
      ...
      scrollProgress.style.background = `conic-gradient(#14B8A6 ${scrollValue}%, #000 ${scrollValue}%)`;
    };
  ...
  return (
    ...
    >
      <div className="bg-[#09182e] w-11 h-11 rounded-full text-primary text-2xl grid place-items-center">
        <HiArrowUp />
      </div>
    </button>
  );
